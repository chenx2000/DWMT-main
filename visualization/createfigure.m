...
set(plot1(3),'DisplayName',' TSA-Net, corr: '+string(roundn(Corr(2),-4)),'Color',[0.66 0.01 0.62]);
set(plot1(4),'DisplayName',' MST, corr: '+string(roundn(Corr(3),-4)),'Color',[1 1 0]);
set(plot1(5),'DisplayName',' CST, corr: '+string(roundn(Corr(4),-4)),'Color',[0 0.5 0.5]);
set(plot1(6),'DisplayName',' DWMT, corr: '+string(roundn(Corr(5),-4)),'Color',[0 1 0]);
